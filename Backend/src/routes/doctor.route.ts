...
import { addDoctor, changeAvailability, deleteDoctor, editDoctor, getAllDoctors, getAvailableDoctorsToday, getDoctorById, getDoctorTodaySlots } from "../controllers/doctor.controller";
